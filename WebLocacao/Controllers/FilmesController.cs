...
namespace WebLocacao.Models
{
    public class FilmesController : Controller
    {
        ...
        {
            var filmes = db.Filmes.ToList().OrderBy(f => f.Filme);
            int paginaTamanho = 4;
            int paginaNumero = (pagina ?? 1);
            return View(filmes.ToPagedList(paginaNumero, paginaTamanho));
        }
        ...
        public ActionResult Create([Bind(Include = "ID,Filme,Genero")] Filmes filmes)
        {
